...
module.exports = {
    ...
    */
    run: async (client, interaction) => {
        ...
        var danceStart = 0;
        var danceEnd = whiteListed.includes(interaction.user.id) ? 480 : 120;
        const maxInput = whiteListed.includes(interaction.user.id) ? 1800 : 600;
        const maxMinute = whiteListed.includes(interaction.user.id) ? 30 : 10;
        ...
        const generationString = `Generating video... <a:boypet2:1168249848055734343>`;
